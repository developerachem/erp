...
import editCss from './salseEdit.module.css'
    ...
    return (
        <>
            <chakra.form onSubmit={handleSubmitEditInvoice}>
                <div className="flex justify-between items-center border mb-3 rounded-md p-4" style={{borderColor : 'var(--border)', backgroundColor : 'var(--bg)'}}>
                    <h1 className='text-xl' style={{color : 'var(--text)'}}>Add New Invoice</h1>
                    <Button 
                        className={editCss.submit} 
                        type='submit' 
                    >{loading ? <Spinner size='xs' /> : "Update" }</Button>
                </div>
                <div className="border rounded-md mb-3 p-5 mt-5" style={{borderColor : 'var(--border)', backgroundColor : 'var(--bg)'}}>
                    <h1>Details</h1>
            ...
            <div className="border rounded-md p-5 mt-5" style={{borderColor : 'var(--border)', backgroundColor : 'var(--bg)'}}>
                <div className="flex justify-between mb-3">
                    <h1>Items</h1>
                    <Button 
                        onClick={handleItemAdd} 
                        className={editCss.add_item}
                    >
                        <HiPlus />
                        Add Item
                    </Button>
